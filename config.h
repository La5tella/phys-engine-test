...
#define NUM_PARTICLES 20//number of particles
...
#define PHYS_MOMENTUM_FAC 0.6f //how much momentum remains post collision.
#define PHYS_ACCEL_FAC 0.6f //how much gyro affects acceleration
#define PHYS_MAX_VELOCITY 15.0f
#define PHYS_MAX_ACCEL 10.0f
#define PHYS_SMOOTH_VALUE 0.7f //Value of smoothing. should be between 0[no smoothing] and .5[full smoothing])
#define PHYS_INIT_CELL_CAP 5 //How many particles can be in a cell before reallocation of memory size
#define PHYS_CELL_CAP 10 //most amount of particles per cell.
